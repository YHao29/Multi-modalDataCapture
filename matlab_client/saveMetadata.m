function saveMetadata(metadata, sceneInfo, staffCombo, savePath, repeatIndex)
...
%   saveMetadata(metadata, sceneInfo, 'yh-ssk', 'D:\data\', 1);

    try
        % 构建文件名
        metaFilename = sprintf('%s-%s-%02d_meta.json', staffCombo, sceneInfo.code, repeatIndex);
